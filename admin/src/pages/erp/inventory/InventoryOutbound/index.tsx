...
import { ErpOutboundOrderQueryCondition, ErpOutboundOrderResponse, pageOtherErpOutboundOrder, pageSaleErpOutboundOrder } from '@/api';
...
export default function ErpOutboundOrder() {
  ...
  const queryRecords = async (condition: ErpOutboundOrderQueryCondition) => {
    const result = await pageOtherErpOutboundOrder(condition);
