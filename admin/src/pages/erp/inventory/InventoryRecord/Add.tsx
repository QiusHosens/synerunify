...
import { createErpInventoryRecord, ErpInventoryRecordRequest } from '@/api';
...
interface ErpInventoryRecordAddProps {
  onSubmit: () => void;
}

const ErpInventoryRecordAdd = forwardRef(({ onSubmit }: ErpInventoryRecordAddProps, ref) => {
  ...
  const handleSubmit = async () => {
    if (validateForm()) {
      await createErpInventoryRecord(formValues as ErpInventoryRecordRequest);
      handleClose();
      onSubmit();
    }
  };
...
export default ErpInventoryRecordAdd;