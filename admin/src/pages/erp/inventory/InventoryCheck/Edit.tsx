...
import { ErpInventoryCheckRequest, ErpInventoryCheckResponse, updateErpInventoryCheck } from '@/api';
...
const ErpInventoryCheckEdit = forwardRef(({ onSubmit }: ErpInventoryCheckEditProps, ref) => {
  ...
  const [erpInventoryCheck, setErpInventoryCheck] = useState<ErpInventoryCheckRequest>({
    id: 0,
    warehouse_id: 0,
    product_id: 0,
    checked_quantity: 0,
  ...
  const initForm = (erpInventoryCheck: ErpInventoryCheckResponse) => {
    setErpInventoryCheck({
      ...erpInventoryCheck,
    })
    setErrors({});
  }
  ...
  const handleSubmit = async () => {
    if (validateForm()) {
      await updateErpInventoryCheck(erpInventoryCheck);
      handleClose();
      onSubmit();
    }
  };
      ...
      >
        <FormControl sx={ {minWidth: 120, '& .MuiTextField-root': { mt: 2, width: '200px' }} }>
          <TextField
            ...
            name='warehouse_id'
            value={ erpInventoryCheck.warehouse_id}
          ...
          <TextField
            ...
            name='product_id'
            value={ erpInventoryCheck.product_id}
            onChange={handleInputChange}
          />
          <TextField
            required
            ...
            value={ erpInventoryCheck.checked_quantity}
            onChange={handleInputChange}
          ...
          <TextField
            ...
            name='check_date'
            value={ erpInventoryCheck.check_date}
            onChange={handleInputChange}
          ...
          <TextField
            ...
            name='remarks'
            value={ erpInventoryCheck.remarks}
            onChange={handleInputChange}
          />
          <TextField
            required
            ...
            value={ erpInventoryCheck.department_code}
            onChange={handleInputChange}
          ...
          <TextField
            ...
            name='department_id'
            value={ erpInventoryCheck.department_id}
            onChange={handleInputChange}
