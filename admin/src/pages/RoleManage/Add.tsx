      ...
      <DialogContent>
        ...
        >
          <FormControl sx={{ mt: 2, minWidth: 120, '& .MuiSelect-root': { width: '200px' } }}>
            <DictSelect name='type' type='number' dict_type='role_type' value={formValues.type.toString()} onChange={(event) => handleInputChange(event as any)} label={t("page.role.title.type")}></DictSelect>
          </FormControl>
