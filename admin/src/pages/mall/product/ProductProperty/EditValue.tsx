...
interface MallProductPropertyEditValueProps {
  onSubmit: () => void;
}

const MallProductPropertyEditValue = forwardRef(({ onSubmit }: MallProductPropertyEditValueProps, ref) => {
...
export default MallProductPropertyEditValue;