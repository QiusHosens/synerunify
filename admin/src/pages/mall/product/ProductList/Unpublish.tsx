...
import { listMallStore, listMallStoreByProduct, MallProductSpuPublishRequest, MallProductSpuResponse, unpublishMallProductSpu } from '@/api';
...
interface MallProductSpuUnpublishProps {
  onSubmit: () => void;
}

const MallProductSpuUnpublish = forwardRef(({ onSubmit }: MallProductSpuUnpublishProps, ref) => {
  ...
  const handleSubmit = async () => {
    if (validateForm()) {
      await unpublishMallProductSpu(mallProductSpuPublish);
      handleClose();
      onSubmit();
    }
  };
...
export default MallProductSpuUnpublish;