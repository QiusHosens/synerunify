...
const apis = {
  create: '/erp/mall_promotion_banner/create', // 新增
  update: '/erp/mall_promotion_banner/update', // 修改
  delete: '/erp/mall_promotion_banner/delete', // 删除
  get: '/erp/mall_promotion_banner/get', // 单条查询
  list: '/erp/mall_promotion_banner/list', // 列表查询
  page: '/erp/mall_promotion_banner/page', // 分页查询
  enable: '/erp/mall_promotion_banner/enable', // 启用
  disable: '/erp/mall_promotion_banner/disable', // 禁用
}
