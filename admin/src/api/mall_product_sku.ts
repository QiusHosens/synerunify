...
const apis = {
  create: '/erp/mall_product_sku/create', // 新增
  update: '/erp/mall_product_sku/update', // 修改
  delete: '/erp/mall_product_sku/delete', // 删除
  get: '/erp/mall_product_sku/get', // 单条查询
  list: '/erp/mall_product_sku/list', // 列表查询
  page: '/erp/mall_product_sku/page', // 分页查询
}
