...
const apis = {
  create: '/erp/mall_product_category/create', // 新增
  update: '/erp/mall_product_category/update', // 修改
  delete: '/erp/mall_product_category/delete', // 删除
  get: '/erp/mall_product_category/get', // 单条查询
  list: '/erp/mall_product_category/list', // 列表查询
  page: '/erp/mall_product_category/page', // 分页查询
  enable: '/erp/mall_product_category/enable', // 启用
  disable: '/erp/mall_product_category/disable', // 禁用
}
