...
const apis = {
  create: '/mall/mall_promotion_kefu_conversation/create', // 新增
  update: '/mall/mall_promotion_kefu_conversation/update', // 修改
  delete: '/mall/mall_promotion_kefu_conversation/delete', // 删除
  get: '/mall/mall_promotion_kefu_conversation/get', // 单条查询
  list: '/mall/mall_promotion_kefu_conversation/list', // 列表查询
  page: '/mall/mall_promotion_kefu_conversation/page', // 分页查询
}
