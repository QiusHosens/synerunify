...
const apis = {
  create: '/mall/mall_promotion_seckill_product/create', // 新增
  update: '/mall/mall_promotion_seckill_product/update', // 修改
  delete: '/mall/mall_promotion_seckill_product/delete', // 删除
  get: '/mall/mall_promotion_seckill_product/get', // 单条查询
  list: '/mall/mall_promotion_seckill_product/list', // 列表查询
  page: '/mall/mall_promotion_seckill_product/page', // 分页查询
}
