...
const apis = {
  create: '/erp/erp_settlement_account/create', // 新增
  update: '/erp/erp_settlement_account/update', // 修改
  delete: '/erp/erp_settlement_account/delete', // 删除
  get: '/erp/erp_settlement_account/get', // 单条查询
  list: '/erp/erp_settlement_account/list', // 列表查询
  page: '/erp/erp_settlement_account/page', // 分页查询
  enable: '/erp/erp_settlement_account/enable', // 启用
  disable: '/erp/erp_settlement_account/disable', // 禁用
}
