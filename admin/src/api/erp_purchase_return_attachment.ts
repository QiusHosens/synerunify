...
export interface ErpPurchaseReturnAttachmentBaseResponse {
  id: number; // 附件ID
  file_id: number; // 文件ID
  remarks: string; // 备注
...
export interface ErpPurchaseReturnAttachmentQueryCondition
  extends PaginatedRequest {}

export const createErpPurchaseReturnAttachment = (
  erp_purchase_return_attachment: ErpPurchaseReturnAttachmentRequest
): Promise<number> => {
  return api.post<number>(apis.create, erp_purchase_return_attachment);
};

export const updateErpPurchaseReturnAttachment = (
  erp_purchase_return_attachment: ErpPurchaseReturnAttachmentRequest
): Promise<void> => {
  return api.post<void>(apis.update, erp_purchase_return_attachment);
};

export const deleteErpPurchaseReturnAttachment = (
  id: number
): Promise<void> => {
  return api.post<void>(`${apis.delete}/${id}`);
};

export const getErpPurchaseReturnAttachment = (
  id: number
): Promise<ErpPurchaseReturnAttachmentResponse> => {
  return api.get<ErpPurchaseReturnAttachmentResponse>(`${apis.get}/${id}`);
};

export const listErpPurchaseReturnAttachment = (): Promise<
  Array<ErpPurchaseReturnAttachmentResponse>
> => {
  return api.get<Array<ErpPurchaseReturnAttachmentResponse>>(apis.list);
};

export const pageErpPurchaseReturnAttachment = (
  condition: ErpPurchaseReturnAttachmentQueryCondition
): Promise<PaginatedResponse<ErpPurchaseReturnAttachmentResponse>> => {
  return api.get<PaginatedResponse<ErpPurchaseReturnAttachmentResponse>>(
    apis.page,
    condition
  );
};
