...
const apis = {
  create: '/erp_purchase_order_detail/create', // 新增
  update: '/erp_purchase_order_detail/update', // 修改
  delete: '/erp_purchase_order_detail/delete', // 删除
  get: '/erp_purchase_order_detail/get', // 单条查询
  list: '/erp_purchase_order_detail/list', // 列表查询
  page: '/erp_purchase_order_detail/page', // 分页查询
}
