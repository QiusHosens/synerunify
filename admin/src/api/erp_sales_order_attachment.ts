...
const apis = {
  create: '/erp/erp_sales_order_attachment/create', // 新增
  update: '/erp/erp_sales_order_attachment/update', // 修改
  delete: '/erp/erp_sales_order_attachment/delete', // 删除
  get: '/erp/erp_sales_order_attachment/get', // 单条查询
  list: '/erp/erp_sales_order_attachment/list', // 列表查询
  page: '/erp/erp_sales_order_attachment/page', // 分页查询
}
