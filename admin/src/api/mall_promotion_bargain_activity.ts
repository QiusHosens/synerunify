...
const apis = {
  create: '/erp/mall_promotion_bargain_activity/create', // 新增
  update: '/erp/mall_promotion_bargain_activity/update', // 修改
  delete: '/erp/mall_promotion_bargain_activity/delete', // 删除
  get: '/erp/mall_promotion_bargain_activity/get', // 单条查询
  list: '/erp/mall_promotion_bargain_activity/list', // 列表查询
  page: '/erp/mall_promotion_bargain_activity/page', // 分页查询
  enable: '/erp/mall_promotion_bargain_activity/enable', // 启用
  disable: '/erp/mall_promotion_bargain_activity/disable', // 禁用
}
