...
const apis = {
  create: '/erp_receipt/create', // 新增
  update: '/erp_receipt/update', // 修改
  delete: '/erp_receipt/delete', // 删除
  get: '/erp_receipt/get', // 单条查询
  list: '/erp_receipt/list', // 列表查询
  page: '/erp_receipt/page', // 分页查询
}
