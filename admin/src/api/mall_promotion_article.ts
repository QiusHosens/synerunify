...
const apis = {
  create: '/erp/mall_promotion_article/create', // 新增
  update: '/erp/mall_promotion_article/update', // 修改
  delete: '/erp/mall_promotion_article/delete', // 删除
  get: '/erp/mall_promotion_article/get', // 单条查询
  list: '/erp/mall_promotion_article/list', // 列表查询
  page: '/erp/mall_promotion_article/page', // 分页查询
  enable: '/erp/mall_promotion_article/enable', // 启用
  disable: '/erp/mall_promotion_article/disable', // 禁用
}
