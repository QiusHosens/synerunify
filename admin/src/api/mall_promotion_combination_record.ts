...
const apis = {
  create: '/erp/mall_promotion_combination_record/create', // 新增
  update: '/erp/mall_promotion_combination_record/update', // 修改
  delete: '/erp/mall_promotion_combination_record/delete', // 删除
  get: '/erp/mall_promotion_combination_record/get', // 单条查询
  list: '/erp/mall_promotion_combination_record/list', // 列表查询
  page: '/erp/mall_promotion_combination_record/page', // 分页查询
  enable: '/erp/mall_promotion_combination_record/enable', // 启用
  disable: '/erp/mall_promotion_combination_record/disable', // 禁用
}
