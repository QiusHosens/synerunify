...
const apis = {
  create: '/erp/mall_trade_delivery_express_template_charge/create', // 新增
  update: '/erp/mall_trade_delivery_express_template_charge/update', // 修改
  delete: '/erp/mall_trade_delivery_express_template_charge/delete', // 删除
  get: '/erp/mall_trade_delivery_express_template_charge/get', // 单条查询
  list: '/erp/mall_trade_delivery_express_template_charge/list', // 列表查询
  page: '/erp/mall_trade_delivery_express_template_charge/page', // 分页查询
}
