...
const apis = {
  create: '/erp/mall_product_comment/create', // 新增
  update: '/erp/mall_product_comment/update', // 修改
  delete: '/erp/mall_product_comment/delete', // 删除
  get: '/erp/mall_product_comment/get', // 单条查询
  list: '/erp/mall_product_comment/list', // 列表查询
  page: '/erp/mall_product_comment/page', // 分页查询
}
