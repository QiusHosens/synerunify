...
export const createErpPaymentDetail = (erp_payment_detail: ErpPaymentDetailRequest): Promise<number> => {
  return api.post<number>(apis.create, erp_payment_detail);
}

export const updateErpPaymentDetail = (erp_payment_detail: ErpPaymentDetailRequest): Promise<void> => {
...
export const getErpPaymentDetail = (id: number): Promise<ErpPaymentDetailResponse> => {
  return api.get<ErpPaymentDetailResponse>(`${apis.get}/${id}`);
}

export const listErpPaymentDetail = (): Promise<Array<ErpPaymentDetailResponse>> => {
  return api.get<Array<ErpPaymentDetailResponse>>(apis.list);
}

export const pageErpPaymentDetail = (condition: ErpPaymentDetailQueryCondition): Promise<PaginatedResponse<ErpPaymentDetailResponse>> => {
  return api.get<PaginatedResponse<ErpPaymentDetailResponse>>(apis.page, condition);
}
