...
const apis = {
  create: '/erp/mall_trade_statistics/create', // 新增
  update: '/erp/mall_trade_statistics/update', // 修改
  delete: '/erp/mall_trade_statistics/delete', // 删除
  get: '/erp/mall_trade_statistics/get', // 单条查询
  list: '/erp/mall_trade_statistics/list', // 列表查询
  page: '/erp/mall_trade_statistics/page', // 分页查询
}
