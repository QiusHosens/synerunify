...
const apis = {
  create: '/erp/mall_product_browse_history/create', // 新增
  update: '/erp/mall_product_browse_history/update', // 修改
  delete: '/erp/mall_product_browse_history/delete', // 删除
  get: '/erp/mall_product_browse_history/get', // 单条查询
  list: '/erp/mall_product_browse_history/list', // 列表查询
  page: '/erp/mall_product_browse_history/page', // 分页查询
}
