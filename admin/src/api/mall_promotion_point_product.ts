...
const apis = {
  create: '/erp/mall_promotion_point_product/create', // 新增
  update: '/erp/mall_promotion_point_product/update', // 修改
  delete: '/erp/mall_promotion_point_product/delete', // 删除
  get: '/erp/mall_promotion_point_product/get', // 单条查询
  list: '/erp/mall_promotion_point_product/list', // 列表查询
  page: '/erp/mall_promotion_point_product/page', // 分页查询
}
