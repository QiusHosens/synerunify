...
export const createMallProductFavorite = (
  mall_product_favorite: MallProductFavoriteRequest
): Promise<number> => {
  return api.post<number>(apis.create, mall_product_favorite);
};

export const updateMallProductFavorite = (
  mall_product_favorite: MallProductFavoriteRequest
): Promise<void> => {
...
export const getMallProductFavorite = (
  id: number
): Promise<MallProductFavoriteResponse> => {
  return api.get<MallProductFavoriteResponse>(`${apis.get}/${id}`);
};

export const listMallProductFavorite = (): Promise<
  Array<MallProductFavoriteResponse>
> => {
  return api.get<Array<MallProductFavoriteResponse>>(apis.list);
};

export const pageMallProductFavorite = (
  condition: MallProductFavoriteQueryCondition
): Promise<PaginatedResponse<MallProductFavoriteResponse>> => {
  return api.get<PaginatedResponse<MallProductFavoriteResponse>>(
    apis.page,
    condition
  );
};
