...
const apis = {
  create: '/erp_product/create', // 新增
  update: '/erp_product/update', // 修改
  delete: '/erp_product/delete', // 删除
  get: '/erp_product/get', // 单条查询
  list: '/erp_product/list', // 列表查询
  page: '/erp_product/page', // 分页查询
  enable: '/erp_product/enable', // 启用
  disable: '/erp_product/disable', // 禁用
}
