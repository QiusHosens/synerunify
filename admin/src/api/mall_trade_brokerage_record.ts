...
const apis = {
  create: '/erp/mall_trade_brokerage_record/create', // 新增
  update: '/erp/mall_trade_brokerage_record/update', // 修改
  delete: '/erp/mall_trade_brokerage_record/delete', // 删除
  get: '/erp/mall_trade_brokerage_record/get', // 单条查询
  list: '/erp/mall_trade_brokerage_record/list', // 列表查询
  page: '/erp/mall_trade_brokerage_record/page', // 分页查询
  enable: '/erp/mall_trade_brokerage_record/enable', // 启用
  disable: '/erp/mall_trade_brokerage_record/disable', // 禁用
}
