...
export interface ErpPurchaseReturnDetailQueryCondition extends PaginatedRequest {
  
}

export const createErpPurchaseReturnDetail = (erp_purchase_return_detail: ErpPurchaseReturnDetailRequest): Promise<number> => {
  return api.post<number>(apis.create, erp_purchase_return_detail);
}

export const updateErpPurchaseReturnDetail = (erp_purchase_return_detail: ErpPurchaseReturnDetailRequest): Promise<void> => {
...
export const getErpPurchaseReturnDetail = (id: number): Promise<ErpPurchaseReturnDetailResponse> => {
  return api.get<ErpPurchaseReturnDetailResponse>(`${apis.get}/${id}`);
}

export const listErpPurchaseReturnDetail = (): Promise<Array<ErpPurchaseReturnDetailResponse>> => {
  return api.get<Array<ErpPurchaseReturnDetailResponse>>(apis.list);
}

export const pageErpPurchaseReturnDetail = (condition: ErpPurchaseReturnDetailQueryCondition): Promise<PaginatedResponse<ErpPurchaseReturnDetailResponse>> => {
  return api.get<PaginatedResponse<ErpPurchaseReturnDetailResponse>>(apis.page, condition);
}
