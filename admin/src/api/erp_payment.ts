...
const apis = {
  create: '/erp_payment/create', // 新增
  update: '/erp_payment/update', // 修改
  delete: '/erp_payment/delete', // 删除
  get: '/erp_payment/get', // 单条查询
  list: '/erp_payment/list', // 列表查询
  page: '/erp_payment/page', // 分页查询
}
