...
const apis = {
  create: '/erp/mall_promotion_article_category/create', // 新增
  update: '/erp/mall_promotion_article_category/update', // 修改
  delete: '/erp/mall_promotion_article_category/delete', // 删除
  get: '/erp/mall_promotion_article_category/get', // 单条查询
  list: '/erp/mall_promotion_article_category/list', // 列表查询
  page: '/erp/mall_promotion_article_category/page', // 分页查询
  enable: '/erp/mall_promotion_article_category/enable', // 启用
  disable: '/erp/mall_promotion_article_category/disable', // 禁用
}
