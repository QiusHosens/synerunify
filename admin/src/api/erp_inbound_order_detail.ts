...
export const createErpInboundOrderDetail = (erp_inbound_order_detail: ErpInboundOrderDetailRequest): Promise<number> => {
  return api.post<number>(apis.create, erp_inbound_order_detail);
}

export const updateErpInboundOrderDetail = (erp_inbound_order_detail: ErpInboundOrderDetailRequest): Promise<void> => {
...
export const getErpInboundOrderDetail = (id: number): Promise<ErpInboundOrderDetailResponse> => {
  return api.get<ErpInboundOrderDetailResponse>(`${apis.get}/${id}`);
}

export const listErpInboundOrderDetail = (): Promise<Array<ErpInboundOrderDetailResponse>> => {
  return api.get<Array<ErpInboundOrderDetailResponse>>(apis.list);
}

export const pageErpInboundOrderDetail = (condition: ErpInboundOrderDetailQueryCondition): Promise<PaginatedResponse<ErpInboundOrderDetailResponse>> => {
  return api.get<PaginatedResponse<ErpInboundOrderDetailResponse>>(apis.page, condition);
}
