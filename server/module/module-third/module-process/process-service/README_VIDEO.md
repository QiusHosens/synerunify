...
本功能实现了视频流拉取和实时YOLO11目标检测，支持多种视频流协议（RTSP、RTMP、HTTP等），并提供Web界面实时展示检测结果。

**YOLO11是Ultralytics最新的目标检测模型，相比YOLOv8具有更高的精度和速度。**
