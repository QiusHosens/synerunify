...
use crate::model::system_user::{ActiveModel as SystemUserEntity, Column};
...
impl SystemUserService {
    ...
    pub async fn get_paginated(&self, params: PaginatedKeywordRequest) -> Result<PaginatedResponse<SystemUserResponse>> {
