...
use crate::model::system_department::{ActiveModel as SystemDepartmentEntity, Column};
...
impl SystemDepartmentService {
    ...
    pub async fn get_paginated(&self, params: PaginatedKeywordRequest) -> Result<PaginatedResponse<SystemDepartmentResponse>> {
