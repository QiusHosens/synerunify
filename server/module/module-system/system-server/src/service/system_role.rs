...
use crate::model::system_role::{ActiveModel as SystemRoleEntity, Column};
...
impl SystemRoleService {
    ...
    pub async fn get_paginated(&self, params: PaginatedKeywordRequest) -> Result<PaginatedResponse<SystemRoleResponse>> {
