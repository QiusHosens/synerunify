...
impl Related<super::system_department::Entity> for SystemDepartmentEntity {
    fn to() -> RelationDef {
        panic!("No relations defined")
    }
}

impl ActiveModelBehavior for SystemDepartmentActiveModel {}