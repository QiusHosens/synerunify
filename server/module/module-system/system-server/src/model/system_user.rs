...
use crate::model::{system_user_role, system_department};
...
pub enum Relation {
    ...
    #[sea_orm(
        ...
        from = "Column::Id",
        to = "system_user_role::Column::UserId"
    )]
    UserRole,

    #[sea_orm(
        belongs_to = "super::system_department::Entity",
        from = "Column::DepartmentId",
        to = "system_department::Column::Id"
    )]
    UserDepartment,
}
