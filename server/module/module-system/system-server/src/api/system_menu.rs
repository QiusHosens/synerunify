...
#[utoipa::path(
    ...
    responses(
        (status = 200, description = "get by id", body = Option<SystemMenuResponse>)
    ),
    tag = "system_menu"
)]
async fn get_by_id(
...
#[utoipa::path(
    ...
    responses(
        (status = 200, description = "get page", body = SystemMenuResponse)
    ),
    tag = "system_menu"
)]
async fn page(
...
#[utoipa::path(
    ...
    path = "/list",
    responses(
        (status = 200, description = "list all", body = Vec<SystemMenuResponse>)
    ),
    tag = "system_menu"
)]
