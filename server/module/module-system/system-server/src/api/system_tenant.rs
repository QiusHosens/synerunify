...
#[utoipa::path(
    ...
    responses(
        (status = 200, description = "get by id", body = Option<SystemTenantResponse>)
    ),
    tag = "system_tenant"
)]
async fn get_by_id(
...
#[utoipa::path(
    ...
    responses(
        (status = 200, description = "get page", body = SystemTenantResponse)
    ),
    tag = "system_tenant"
)]
async fn page(
...
#[utoipa::path(
    ...
    path = "/list",
    responses(
        (status = 200, description = "list all", body = Vec<SystemTenantResponse>)
    ),
    tag = "system_tenant"
)]
