...
pub struct CreateMallProductCommentRequest {
...
#[derive(Serialize, Deserialize, Debug, ToSchema)]
pub struct UpdateMallProductCommentRequest {
    
    pub id: i64, // 评论编号，主键自增
    
    pub user_id: Option<i64>, // 评价人的用户编号，关联 MemberUserDO 的 id 编号
    
    pub user_nickname: Option<String>, // 评价人名称
    
    pub user_avatar: Option<String>, // 评价人头像
    
    pub anonymous: Option<bool>, // 是否匿名
    
    pub order_id: Option<i64>, // 交易订单编号，关联 TradeOrderDO 的 id 编号
    
    pub order_item_id: Option<i64>, // 交易订单项编号，关联 TradeOrderItemDO 的 id 编号
    
    pub spu_id: Option<i64>, // 商品 SPU 编号，关联 ProductSpuDO 的 id
    
    pub spu_name: Option<String>, // 商品 SPU 名称
    
    pub sku_id: Option<i64>, // 商品 SKU 编号，关联 ProductSkuDO 的 id 编号
    
    pub sku_pic_url: Option<String>, // 图片地址
    
    pub sku_properties: Option<String>, // 属性数组，JSON 格式 [{propertId: , valueId: }, {propertId: , valueId: }]
    
    pub visible: Option<bool>, // 是否可见，true:显示false:隐藏
    
    pub scores: Option<i8>, // 评分星级1-5分
    
    pub description_scores: Option<i8>, // 描述星级 1-5 星
    
    pub benefit_scores: Option<i8>, // 服务星级 1-5 星
