...
use crate::model::{mall_product_category, mall_product_brand, mall_product_store};
...
pub enum Relation {
    #[sea_orm(
        belongs_to = "super::mall_product_category::Entity",
        from = "Column::CategoryId",
        to = "mall_product_category::Column::Id"
    )]
    ProductCategory,

    #[sea_orm(
        belongs_to = "super::mall_product_brand::Entity",
        from = "Column::BrandId",
        to = "mall_product_brand::Column::Id"
    )]
    ProductBrand,

    #[sea_orm(
        belongs_to = "super::mall_product_store::Entity",
        from = "Column::Id",
        to = "mall_product_store::Column::ProductId"
    )]
    ProductStore,
}
