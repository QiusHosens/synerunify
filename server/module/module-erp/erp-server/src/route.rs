...
use crate::api::erp_purchase_return_attachment::{ erp_purchase_return_attachment_route, erp_purchase_return_attachment_router };
use crate::api::erp_purchase_return_detail::{ erp_purchase_return_detail_route, erp_purchase_return_detail_router };
...
use crate::api::erp_sales_return_attachment::{ erp_sales_return_attachment_route, erp_sales_return_attachment_router };
use crate::api::erp_sales_return_detail::{ erp_sales_return_detail_route, erp_sales_return_detail_router };
...
#[openapi(
    ...
    tags(
        ...
        (name = "erp_purchase_return_attachment", description = "采购订单附件"),
        (name = "erp_purchase_return_detail", description = "采购订单详情"),
        ...
        (name = "erp_sales_return_attachment", description = "销售退货附件"),
        (name = "erp_sales_return_detail", description = "销售退货详情"),
...
pub async fn auth_router(state: AppState) -> OpenApiRouter {
    OpenApiRouter::new()
        ...
        .nest("/erp_purchase_return_attachment", erp_purchase_return_attachment_router(state.clone()).await)
        .nest("/erp_purchase_return_detail", erp_purchase_return_detail_router(state.clone()).await)
        ...
        .nest("/erp_sales_return_attachment", erp_sales_return_attachment_router(state.clone()).await)
        .nest("/erp_sales_return_detail", erp_sales_return_detail_router(state.clone()).await)
