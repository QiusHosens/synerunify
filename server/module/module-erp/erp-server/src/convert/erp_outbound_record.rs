...
use crate::model::erp_outbound_record::{self, Model as ErpOutboundRecord, ActiveModel as ErpOutboundRecordActiveModel};
use erp_model::request::erp_outbound_record::{CreateErpOutboundRecordRequest, UpdateErpOutboundRecordRequest};
use erp_model::response::erp_outbound_record::ErpOutboundRecordResponse;

pub fn create_request_to_model(request: &CreateErpOutboundRecordRequest) -> ErpOutboundRecordActiveModel {
    ErpOutboundRecordActiveModel {
...
pub fn update_request_to_model(request: &UpdateErpOutboundRecordRequest, existing: ErpOutboundRecord) -> ErpOutboundRecordActiveModel {
    let mut active_model: ErpOutboundRecordActiveModel = existing.into();
...
pub fn model_to_response(model: ErpOutboundRecord) -> ErpOutboundRecordResponse {
    ErpOutboundRecordResponse { 
        id: model.id,
