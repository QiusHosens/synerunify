...
use crate::model::erp_suppliers::{self, Model as ErpSuppliers, ActiveModel as ErpSuppliersActiveModel};
use erp_model::request::erp_suppliers::{CreateErpSuppliersRequest, UpdateErpSuppliersRequest};
use erp_model::response::erp_suppliers::ErpSuppliersResponse;

pub fn create_request_to_model(request: &CreateErpSuppliersRequest) -> ErpSuppliersActiveModel {
    ErpSuppliersActiveModel {
...
pub fn update_request_to_model(request: &UpdateErpSuppliersRequest, existing: ErpSuppliers) -> ErpSuppliersActiveModel {
    let mut active_model: ErpSuppliersActiveModel = existing.into();
...
pub fn model_to_response(model: ErpSuppliers) -> ErpSuppliersResponse {
