...
use crate::model::erp_purchase_order_details::{self, Model as ErpPurchaseOrderDetails, ActiveModel as ErpPurchaseOrderDetailsActiveModel};
use erp_model::request::erp_purchase_order_details::{CreateErpPurchaseOrderDetailsRequest, UpdateErpPurchaseOrderDetailsRequest};
use erp_model::response::erp_purchase_order_details::ErpPurchaseOrderDetailsResponse;

pub fn create_request_to_model(request: &CreateErpPurchaseOrderDetailsRequest) -> ErpPurchaseOrderDetailsActiveModel {
    ErpPurchaseOrderDetailsActiveModel {
...
pub fn update_request_to_model(request: &UpdateErpPurchaseOrderDetailsRequest, existing: ErpPurchaseOrderDetails) -> ErpPurchaseOrderDetailsActiveModel {
    let mut active_model: ErpPurchaseOrderDetailsActiveModel = existing.into();
...
pub fn model_to_response(model: ErpPurchaseOrderDetails) -> ErpPurchaseOrderDetailsResponse {
    ErpPurchaseOrderDetailsResponse { 
        id: model.id,
