...
use crate::model::erp_receipt_details::{self, Model as ErpReceiptDetails, ActiveModel as ErpReceiptDetailsActiveModel};
use erp_model::request::erp_receipt_details::{CreateErpReceiptDetailsRequest, UpdateErpReceiptDetailsRequest};
use erp_model::response::erp_receipt_details::ErpReceiptDetailsResponse;

pub fn create_request_to_model(request: &CreateErpReceiptDetailsRequest) -> ErpReceiptDetailsActiveModel {
    ErpReceiptDetailsActiveModel {
...
pub fn update_request_to_model(request: &UpdateErpReceiptDetailsRequest, existing: ErpReceiptDetails) -> ErpReceiptDetailsActiveModel {
    let mut active_model: ErpReceiptDetailsActiveModel = existing.into();
...
pub fn model_to_response(model: ErpReceiptDetails) -> ErpReceiptDetailsResponse {
    ErpReceiptDetailsResponse { 
        id: model.id,
