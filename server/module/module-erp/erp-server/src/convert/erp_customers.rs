...
use crate::model::erp_customers::{self, Model as ErpCustomers, ActiveModel as ErpCustomersActiveModel};
use erp_model::request::erp_customers::{CreateErpCustomersRequest, UpdateErpCustomersRequest};
use erp_model::response::erp_customers::ErpCustomersResponse;

pub fn create_request_to_model(request: &CreateErpCustomersRequest) -> ErpCustomersActiveModel {
    ErpCustomersActiveModel {
...
pub fn update_request_to_model(request: &UpdateErpCustomersRequest, existing: ErpCustomers) -> ErpCustomersActiveModel {
    let mut active_model: ErpCustomersActiveModel = existing.into();
...
pub fn model_to_response(model: ErpCustomers) -> ErpCustomersResponse {
    ErpCustomersResponse { 
        id: model.id,
