...
use crate::model::erp_products::{self, Model as ErpProducts, ActiveModel as ErpProductsActiveModel};
use erp_model::request::erp_products::{CreateErpProductsRequest, UpdateErpProductsRequest};
use erp_model::response::erp_products::ErpProductsResponse;

pub fn create_request_to_model(request: &CreateErpProductsRequest) -> ErpProductsActiveModel {
    ErpProductsActiveModel {
...
pub fn update_request_to_model(request: &UpdateErpProductsRequest, existing: ErpProducts) -> ErpProductsActiveModel {
    let mut active_model: ErpProductsActiveModel = existing.into();
...
pub fn model_to_response(model: ErpProducts) -> ErpProductsResponse {
    ErpProductsResponse { 
        id: model.id,
