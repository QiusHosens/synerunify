...
use crate::model::erp_inbound_records::{self, Model as ErpInboundRecords, ActiveModel as ErpInboundRecordsActiveModel};
use erp_model::request::erp_inbound_records::{CreateErpInboundRecordsRequest, UpdateErpInboundRecordsRequest};
use erp_model::response::erp_inbound_records::ErpInboundRecordsResponse;

pub fn create_request_to_model(request: &CreateErpInboundRecordsRequest) -> ErpInboundRecordsActiveModel {
    ErpInboundRecordsActiveModel {
...
pub fn update_request_to_model(request: &UpdateErpInboundRecordsRequest, existing: ErpInboundRecords) -> ErpInboundRecordsActiveModel {
    let mut active_model: ErpInboundRecordsActiveModel = existing.into();
...
pub fn model_to_response(model: ErpInboundRecords) -> ErpInboundRecordsResponse {
    ErpInboundRecordsResponse { 
        id: model.id,
