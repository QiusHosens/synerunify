...
use crate::model::erp_financial_records::{self, Model as ErpFinancialRecords, ActiveModel as ErpFinancialRecordsActiveModel};
use erp_model::request::erp_financial_records::{CreateErpFinancialRecordsRequest, UpdateErpFinancialRecordsRequest};
use erp_model::response::erp_financial_records::ErpFinancialRecordsResponse;

pub fn create_request_to_model(request: &CreateErpFinancialRecordsRequest) -> ErpFinancialRecordsActiveModel {
    ErpFinancialRecordsActiveModel {
...
pub fn update_request_to_model(request: &UpdateErpFinancialRecordsRequest, existing: ErpFinancialRecords) -> ErpFinancialRecordsActiveModel {
    let mut active_model: ErpFinancialRecordsActiveModel = existing.into();
...
pub fn model_to_response(model: ErpFinancialRecords) -> ErpFinancialRecordsResponse {
    ErpFinancialRecordsResponse { 
        id: model.id,
