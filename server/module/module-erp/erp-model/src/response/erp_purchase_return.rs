...
use crate::response::{erp_purchase_return_attachment::ErpPurchaseReturnAttachmentBaseResponse, erp_purchase_return_detail::ErpPurchaseReturnDetailBaseResponse};
...
#[serde_as]
#[derive(Deserialize, Serialize, Debug, Clone, ToSchema)]
pub struct ErpPurchaseReturnPageResponse {
...
#[serde_as]
#[derive(Deserialize, Serialize, Debug, Clone, ToSchema)]
pub struct ErpPurchaseReturnBaseResponse {
    ...
    pub details: Vec<ErpPurchaseReturnDetailBaseResponse>, // 入库采购产品仓库列表

    pub attachments: Vec<ErpPurchaseReturnAttachmentBaseResponse>, // 入库附件列表
    
}

#[serde_as]
#[derive(Deserialize, Serialize, Debug, Clone, ToSchema)]
pub struct ErpPurchaseReturnInfoResponse {
